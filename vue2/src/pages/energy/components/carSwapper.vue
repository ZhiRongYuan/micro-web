...
export default {
  ...
  data () {
    return {
      swapperList: [
        'https://p3.dcarimg.com/img/tos-cn-i-dcdx/6759b43e2c994cf282907e4d903c8632~1270x0.webp',
        'https://p3.dcarimg.com/img/tos-cn-i-dcdx/11302c03af5d42969d75b076b42d1ea6~1270x0.webp',
        'https://p9-dcd-sign.byteimg.com/tos-cn-i-0004/443804f717dd4a93890424f9fba1eee6~tplv-resize:640:0.png?x-expires=1683966111&x-signature=91pl0gtgZdvE%2B8ZoOzdTt0CQQtI%3D',
      ],
      currentIndex: 0,
      leftHover: false,
      rightHover: false,
