 ...
 * @LastEditTime: 2023-04-17 11:12:06
 * @Description:
 */
...
const LoginPanel = () => {
  const goIndex = () => {
    axios.post("/react16/login").then((res) => {
    ...
    <div className="panel">
      ...
      <div className="panelForm">
        <div className="panelFormItem">
          <img
            className="panelFormIcon"
            src={`${globalConfig.baseUrl}/icon-phone.png`}
          />
        ...
        <div className="panelFormItem">
          <img
            className="panelFormIcon"
            src={`${globalConfig.baseUrl}/icon-verification.png`}
          />
          <input className="panelFormInput" placeholder="请输入右侧验证码" />
          <img
            className="panelFormRight"
            src={`${globalConfig.baseUrl}/icon-number.png`}
          />
        </div>
        ...
        <div className="panelFormItem">
          <img
            className="panelFormIcon"
            src={`${globalConfig.baseUrl}/icon-sms.png`}
          />
      ...
      <button className="panelButton" onClick={goIndex}>
        登录
      </button>
    </div>
  );
