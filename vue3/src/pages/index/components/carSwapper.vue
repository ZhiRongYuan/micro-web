 ...
 * @LastEditTime: 2023-04-14 11:35:01
 * @Description: 
-->
<template>
...
export default {
  ...
  data () {
    return {
      swapperList: [
        'https://p3.dcarimg.com/img/motor-article-img/6f51f2020252f453409eaf1f1ab1a44a~500x0.webp',
        'https://p3.dcarimg.com/img/motor-article-img/f43679c7028e47f3b9895f67ace6e8e7~500x0.webp',
        'https://p6-dcd-sign.byteimg.com/tos-cn-i-0004/871057fd02834c169e68f34bb6b04e0b~tplv-resize:640:0.png?x-expires=1684035192&x-signature=5pWRlHI28k0uDo6tyGCIjnNH1z0%3D',
      ],
      currentIndex: 0,
      leftHover: false,
      rightHover: false,
